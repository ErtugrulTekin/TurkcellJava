...
public class Main {
	...
	public static void main(String[] args) {
		...
		elmalar[3] = new Elma(80, "Sarı");
		elmalar[4] = new Elma(15, "Kırmızı");
		elmalar[5] = new Elma(95, "Kırmızı");
		elmalar[6] = new Elma(65, "Yeşil");
		elmalar[7] = new Elma(100, "Kırmızı");
		elmalar[8] = new Elma(70, "Yeşil");
		elmalar[9] = new Elma(35, "Sarı");

//		renkFiltrele("Sarı", elmalar);
//		System.out.println("---------------");
//		agirlikFiltrele(50, elmalar);
//		System.out.println("---------------");
//		agirlikFiltreler2(50, elmalar);
...
//		AgirlikFiltresi agirlikFiltresi = new AgirlikFiltresi();
	...
	public static void agirlikFiltreler2(int agirlik, Elma[] elmalar) {
		for (int i = 0; i < elmalar.length; i++) {
			Elma elma = elmalar[i];
			if (elma.getAgirlik() < agirlik) {
				System.out.println(elma.getRenk() + " " + elma.getAgirlik());
